...
#        logging.info(f'Start: {datetime.now().strftime("%m/%d/%Y, %H:%M:%S")}')
        logging.info(f'Start: {}'.format(datetime.now().strftime("%m/%d/%Y, %H:%M:%S")))
        logging.info("-" * 80)
#        logging.info(f"args: {args}")
        logging.info(f"args: {}".format(args))
        logging.info("-" * 80)
#        logging.info(f"kwargs: {kwargs}")
        logging.info(f"kwargs: {}".format(kwargs))
        logging.info("=" * 80)
        retFunc = f(*args, **kwargs)
        logging.info("=" * 80)
#        logging.info(f"Function: {f.__name__}")
        logging.info(f"Function: {}".format(f.__name__))
#        logging.info(f'End: {datetime.now().strftime("%m/%d/%Y, %H:%M:%S")}')
        logging.info(f'End: {}'.format(datetime.now().strftime("%m/%d/%Y, %H:%M:%S")))
        logging.info("#" * 80)
        logging.info("#" * 80)
        return retFunc
